...
def build_schematic():
    ...
    for name, net in [("RESET", "RESET_N"), ("BOOT", "BOOT"), ("KEY1", "KEY1_N"),
        ...
        b.comp("Switch:SW_Push", "SW", name,
               ...
               # V1.6: the Omron part was confirmed back in V1.1, so all five
    ...
    b.comp("Connector:USB_C_Receptacle_USB2.0_16P", "J", "USB-C 2.0 Sink",
           ...
           (76.2, 260.35, 0), USB_PINS, status=RELEASED,
    ...
    bq_parts = [
        ...
        # core temperature (see PCB_LAYOUT_NOTES / SCHEMATIC_NOTES 6.3).
        ("Device:Thermistor_NTC", "NTC", "10k B3435", FP_R0603,
         {"1": "CHG_TS", "2": "GND"}, RELEASED, "Vishay NTCS0603E3103FLT"),
    ...
    tps_parts = [
        # V1.6: Sunlord MWSA0402S-1R2MT (1.2 uH, DCR 27 mOhm max, Isat 5.2 A,
        # 4.2 x 4.4 mm).  The KiCad library footprint is generated from the
    ...
    b.comp("local:EPD_FPC24", "J", "GDEM102T91 24P FPC",
           # V1.6: XKB X05B20U24T (24P / 0.5 mm / top contact / slide lock).
           # The land pattern is generated by tools/import_xkb_fpc.py from the
           # XKB drawing plus the LCSC CAD data (see that script for sources).
           "esp32-board-v1.1:X05B20U24T",
           (431.8, 245.11, 0), EPD_PINS, status=RELEASED,
           mpn="XKB X05B20U24T", ref="J2")
    ...
    epd_parts = [
        ...
        ("Transistor_FET:Q_NMOS_GSD", "Q", "Si1304BDL",
         "Package_TO_SOT_SMD:SOT-323_SC-70",
         {"G": "EPD_GDR", "D": "EPD_SW", "S": "EPD_RESE"}, RELEASED,
         "Si1304BDL-T1-GE3"),
    ...
    b.comp("Connector:Micro_SD_Card_Det2", "J", "MicroSD",
           ...
           (287.02, 340.36, 0), SD_PINS, status=RELEASED,
